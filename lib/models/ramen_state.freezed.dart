...
mixin _$RamenState<T> {
  ...
  Map<String, GetPlaceDetailsWithImagesResponse> get detail;
...
abstract mixin class $RamenStateCopyWith<T, $Res> {
  ...
  $Res call(
      ...
      Map<String, GetPlaceDetailsWithImagesResponse> detail});
}
    ...
    return _then(_self.copyWith(
      ...
      detail: null == detail
          ...
          : detail // ignore: cast_nullable_to_non_nullable
              as Map<String, GetPlaceDetailsWithImagesResponse>,
    ));
  }
}
...
class _RamenState<T> extends RamenState<T> {
  const _RamenState(
      ...
      final Map<String, GetPlaceDetailsWithImagesResponse> detail = const {}})
      : _places = places,
...
// デフォルト値: 空のセット
  final Map<String, GetPlaceDetailsWithImagesResponse> _detail;
// デフォルト値: 空のセット
  @override
  @JsonKey()
  Map<String, GetPlaceDetailsWithImagesResponse> get detail {
